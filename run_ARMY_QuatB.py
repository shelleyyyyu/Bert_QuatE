...
if __name__ == '__main__':
	...
	parser.add_argument('--bert_ckpt', type=str, default="./benchmarks/army_clean_all_shuffle_small/BertQuatE_word_200000.pt", help='dataset directory')
